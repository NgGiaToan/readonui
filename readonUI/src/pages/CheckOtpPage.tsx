    ...
    const handleClick = async (event: React.FormEvent) =>{
        ...
        try{
            var response = await axios.post(
                `https://localhost:7182/api/Auth/check-otp?username=${resetUser}&otp=${otp}`,
                null,
                {
                  headers: {
                    Accept: "*/*",
        ...
        <div className="animate-fade-in flex items-center justify-center h-screen bg-[#dFDFDF]">
            <div className="flex items-center justify-center bg-white">
                <div className="flex flex-col items-center w-[469px] h-[575px]">
                    <div className="absolute mt-[16px] text-left w-[472px]">
                        <a href="forgot_password" className="border-1 border-l-[white] rounded-r-[12px] py-[3px] px-[16px] text-[12px] font-[500]">BACK</a>
                    </div>
                    <svg className="mt-[100px]" width="73" height="61" viewBox="0 0 73 61" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p className="mt-[12px] text-[36px] font-[400]">Check your Mailbox</p>         
                    <p className="mt-[20px] mb-[20px] text-[14px] text-[#1F1F1F]">Please enter the OTP to proceed</p>     
                    <form onSubmit={handleClick} className="flex flex-col items-center justify-center">
                        ...
                        <button type="submit" className="hover:bg-[#2f2f2f] text-white bg-black text-[15px] font-[600] w-[280px] h-[46px] rounded-[12px]">VERIFY</button>

                    </form>
                    {err != "" ? <div className="text-[red] text-[8px] w-[260px] top-[60%] text-right absolute">{err}</div>:""}
                </div>
                <div className="rounded-l-[32px] text-white flex flex-col items-center bg-black w-[469px] h-[575px]">
                    ...
                    <p className="text-[21px] mt-[72px] w-[260px] font-[300] text-center text-[#bfbfbf]">"Your premier digital library for borrowing and reading books"</p>
                </div>
            </div>
        </div>
    )
