    ...
    const handleClick = async (event: React.FormEvent) =>{
        ...
        try{
            var response = await axios.post(
                `https://localhost:7182/api/Auth/send-otp?username=${username}`,
                null,
                {
                  headers: {
                    Accept: "*/*",
            ...
            <div className="flex items-center justify-center bg-white">
                ...
                <div className="flex flex-col items-center w-[469px] h-[575px]">
                    <div className="absolute mt-[16px] text-right w-[469px]">
                        <a href="signin" className="border-1 border-r-[white] rounded-l-[12px] py-[3px] px-[16px] text-[12px] font-[500]">BACK</a>
                    </div>
                    ...
                    <p className="text-[36px] mt-[16px]">Forgot Password</p>
                    <p className="mt-[12px]">Please enter your username</p>

                    <form onSubmit={handleClick}>
                        <input
                            required
                            type="text"
                            className="pl-[16px] border-1 border-black w-[280px] h-[46px] rounded-[12px] mt-[40px] mb-[28px]"
                            placeholder="Username"
                            value = {username}
                            onChange={(e) => setUsername(e.target.value)}
                        >
                        </input>
                        <button type="submit" className="text-white bg-black text-[15px] font-[600] w-[280px] h-[46px] flex items-center justify-center rounded-[12px]">RESET PASSWORD</button>
                    </form>

                    {err != "" ? <div className="text-[red] text-[7.8px] w-[280px] absolute top-[59.8%] text-right">{err}</div>:""}
                </div>
