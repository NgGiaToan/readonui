...
const PopUpUpdate = ({id, object, handleOut, handleConfirm}:LoanDetailProps) => {
    ...
    const handleUpdate = async (e: React.FormEvent) => {
        ...
        if ( object == "user"){
            try {
                const response = await axiosInstance.put(`https://localhost:7182/api/Account/update-user?id=${id}`,
                    {
                        name,
                        email,
                        username,
                ...
                if (response.status = 201){
                    setErr("Update User Successfully!")
                    setTimeout(handleOut,500);
                    handleConfirm();
                } else {
                    setErr(response.data.message)
        ...
        if ( object == "branch"){
            try {
                const response = await axiosInstance.put(`https://localhost:7182/api/Branch/update-branch?id=${id}`,
                    {
                        name,
                        contactNo: contact,
                        location
                ...
                if (response.status = 201){
                    setErr("Update Branch Successfully!")
                    setTimeout(handleOut,500);
                    handleConfirm();
                } else {
                    setErr(response.data.message)
                    ...
                    <div className="h-[491px] rounded-[16px] w-[627px] bg-white flex flex-col justify-center items-center">
                        <div className="flex items-center">
                            <div className="flex items-center w-[480px]">
                                ...
                                <p className="text-[20px] font-[500] ml-[12px]">Update User</p>
                        ...
                        <div className="mt-[32px] h-[290px] ml-[90px]">
                            <form onSubmit={handleUpdate}>
                                ...
                                <div className="absolute text-[red] top-[570px] w-[440px] left-[848px] text-right">
                                    <p className={err=="Update User Successfully!" ? "text-[green]":""}>{err}</p>
                                </div>
                                <div className="ml-[-44px]">
                                    <button 
                                        className="h-[54px] w-[259px] rounded-[12px] bg-[#D7D7D7] font-[500] mt-[40px]"
                    ...
                    <div className="h-[491px] rounded-[16px] w-[627px] bg-white flex flex-col justify-center items-center">
                        <div className="flex items-center">
                            <div className="flex items-center w-[480px]">
                                ...
                                <p className="text-[20px] font-[500] ml-[12px]">Update Branch</p>
                        ...
                        <div className="mt-[32px] h-[290px] ml-[90px]">
                            <form onSubmit={handleUpdate}>
                                ...
                                <div className="absolute text-[red] top-[570px] w-[440px] left-[848px] text-right">
                                    <p className={err=="Update Branch Successfully!" ? "text-[green]":""}>{err}</p>
                                </div>
                                <div className="ml-[-44px]">
                                    <button 
                                        className="h-[54px] w-[259px] rounded-[12px] bg-[#D7D7D7] font-[500] mt-[40px]"
